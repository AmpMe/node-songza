...
describe('station', function() {
	...
	var station, auth, user, userId;

	before(function() {
		var songza = new Songza({ userAgent: 'node-songza/test:station' });
		station = songza.station;
		auth = songza.auth;
		user = songza.user;
	...
	describe('tests that deal with a single station', function() {
		...
		describe('release', function() {
			...
			it.only('do not release if not enough artists', function() {
				this.timeout(60000);
